...
<div id="stories" class="table-users" style="width:100%">
  ...
  <table class="table">
    ...
    <tr class="table-body" v-for="(result, index) in results" v-if="(index >= (page-1)*page_num) && (index < page_num*page)">
      ...
      <td v-if="flag==false"><button style="width:90px; background-color:#327a81; color:white; font-weight:bold; margin-left=50px" @click="editClick(result)" class="btn">수 정</button></td>
